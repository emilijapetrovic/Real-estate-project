...
<body onload='poruke()'>
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href='PrivilegedUser' class='login'>Moj profil</a></li>
            <li><a href='PrivilegedUser/logout' class='button register'>Odjavi se</a></li>    
        </ul>
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <h5><i>Privilegovan korisnik</i></h5>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="Privilegeduser/izmena" style="width: 100%; ">Izmeni podatke</a>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
